...
CREATE TABLE order_line (
  ...
  ol_number enc_int4 NOT NULL,
  ol_i_id int NOT NULL,
  ol_delivery_d enc_timestamp NULL DEFAULT NULL,
  ol_amount enc_float4 NOT NULL,
  ol_supply_w_id int NOT NULL,
  ol_quantity enc_float4 NOT NULL,
...
CREATE TABLE stock (
  s_w_id int NOT NULL,
  s_i_id int NOT NULL,
  s_quantity enc_float4 NOT NULL,
  s_ytd enc_float4 NOT NULL,
  s_order_cnt enc_int4 NOT NULL,
  s_remote_cnt enc_int4 NOT NULL,
...
CREATE TABLE oorder (
  ...
  o_ol_cnt enc_float4 NOT NULL,
  o_all_local enc_float4 NOT NULL,
...
CREATE TABLE customer (
  ...
  c_d_id int NOT NULL,
  c_id int NOT NULL,
  c_discount enc_float4 NOT NULL,
  c_credit char(2) NOT NULL,
  c_last varchar(16) NOT NULL,
  c_first varchar(16) NOT NULL,
  c_credit_lim enc_float4 NOT NULL,
  c_balance enc_float4 NOT NULL,
  c_ytd_payment enc_float4 NOT NULL,
  c_payment_cnt enc_int4 NOT NULL,
  c_delivery_cnt enc_int4 NOT NULL,
...
CREATE TABLE district (
  d_w_id int NOT NULL,
  d_id int NOT NULL,
  d_ytd enc_float4 NOT NULL,
  d_tax enc_float4 NOT NULL,
...
CREATE TABLE warehouse (
  w_id int NOT NULL,
  w_ytd enc_float4 NOT NULL,
  w_tax enc_float4 NOT NULL,
  w_name enc_text NOT NULL,
