...
#define ENC_INT_LENGTH_B64 45 //((4 * n / 3) + 3) & ~3
#define ENC_INT_LENGTH 32
#define INT_LENGTH sizeof(int)
#define ENC_INT64_LENGTH_B64 45 //((4 * n / 3) + 3) & ~3
#define ENC_INT64_LENGTH 32
#define INT64_LENGTH sizeof(int)

#define DETENC_INT_LENGTH_B64 25 // ((4 * n / 3) + 3) & ~3
#define DETENC_INT_LENGTH 16

#define ENC_FLOAT_LENGTH_B64 45 //((4 * n / 3) + 3) & ~3
#define ENC_FLOAT_LENGTH 32
#define FLOAT_LENGTH 4 //sizeof(float)
...
#define TIMESTAMP_LENGTH sizeof(double)
